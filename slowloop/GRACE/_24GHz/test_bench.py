...
with open("GRACE\config\config_2.4GHz.yaml", "r") as f:
...
trainer.load_weights("GRACE/model_weights/grace_model_2.4GHz.pth")

def get_embeddings2(out, overlap, rssi, x_mean=x_mean, x_std=x_std, ea_mean=ea_mean, ea_std=ea_std, trainer=trainer, config=config):
